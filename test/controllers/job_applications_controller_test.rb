...
class JobApplicationsControllerTest < ActionController::TestCase
  ...
  test "should create job_application" do
    assert_difference('JobApplication.count') do
      post :create, job_application: { appCompleted: @job_application.appCompleted, companyName: @job_application.companyName, companyResponse: @job_application.companyResponse, nextInterview: @job_application.nextInterview }
    end
  ...
  test "should update job_application" do
    patch :update, id: @job_application, job_application: { appCompleted: @job_application.appCompleted, companyName: @job_application.companyName, companyResponse: @job_application.companyResponse, nextInterview: @job_application.nextInterview }
    assert_redirected_to job_application_path(assigns(:job_application))
  end
